...
Version = "v1",
        Description = "Simple API using CQRS + MediatR + Repo + SeriLog + Auth"
    });
});
...
if (app.Environment.IsDevelopment())
{
  app.UseSwagger();
    app.UseSwaggerUI(c =>
    {
        ...
        // c.RoutePrefix = string.Empty; // optional: open at root
    });

    // Map Scalar API reference with proper configuration
    app.MapScalarApiReference(options => options
        .WithTitle("Employee Admin Portal API Documentation")
